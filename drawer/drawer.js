...
const profileSize = window.width / 5;
    ...
    render() {
        const staggeredAnimatedMenus = this.state.stagArr.map((index) => {
            return (
                <TouchableWithoutFeedback key={index} onPress={this._handlePress.bind(this, index)} style={{ backgroundColor: 'red' }}>
                    <Animated.View
                        style={{ transform: [{ translateX: this.state.animatedStagArr[index] }], flex: 10 }}>
        ...
        return (
            <View style={[styles.offCanvasContainer, {
                ...
                <LinearGradient
                    colors={['rgba(68, 160, 141,.7)', 'rgba(9, 54, 55,.7)']}
                        ...
                        <Animated.View style={[styles.menuItemsContainer, {
                            ...
                            <View style={{ flex: 1, flexDirection: 'row' }}>
                                <Image source={profile}
                                    style={{
                                        height: profileSize,
                                        width: profileSize, borderRadius: 50
                                    }} />
                            </View>
                            <View style={{ flex: 1, marginTop: 10 }}>
                                ...
                                <View style={{ flex: 1, flexDirection: 'row' }}>
                                    <Text style={{ color: 'white', fontSize: 14 }}>ID : 01-0001</Text>
                                </View>
                            </View>

                        </Animated.View>
                        <Animated.View style={[styles.menuItemsContainer, { flex: 3 }]}>
